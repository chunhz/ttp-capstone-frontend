...
export const getHotSpots = () => (dispatch) => {
  ...
  axios.get("https://ttp-wifi-finder.herokuapp.com/hotSpots").then((res) =>
    dispatch({
      type: GET_HOTSPOTS,
      payload: res.data,
    })
...
export const getCloseHotSpots = (Postcode) => (dispatch) => {
  dispatch(setHotSpotsLoading());
  axios
    .get(`https://ttp-wifi-finder.herokuapp.com/hotSpots/closeBy${Postcode}`)
    .then((res) =>
      dispatch({
        type: GET_CLOSE,
        payload: res.data,
...
export const getManhattan = () => (dispatch) => {
  dispatch(setHotSpotsLoading());
  axios
    .get(`https://ttp-wifi-finder.herokuapp.com/hotSpots/manhattan`)
    .then((res) =>
      dispatch({
        type: GET_MANHATTAN,
        payload: res.data,
...
export const getQueens = () => (dispatch) => {
  dispatch(setHotSpotsLoading());
  axios
    .get(`https://ttp-wifi-finder.herokuapp.com/hotSpots/queens`)
    .then((res) =>
      dispatch({
        type: GET_QUEENS,
        payload: res.data,
...
export const getStatenIsland = () => (dispatch) => {
  dispatch(setHotSpotsLoading());
  axios
    .get(`https://ttp-wifi-finder.herokuapp.com/hotSpots/statenisland`)
    .then((res) =>
      dispatch({
...
export const getBrooklyn = () => (dispatch) => {
  dispatch(setHotSpotsLoading());
  axios
    .get(`https://ttp-wifi-finder.herokuapp.com/hotSpots/brooklyn`)
    .then((res) =>
      dispatch({
        type: GET_BROOKLYN,
        payload: res.data,
...
export const getBronx = () => (dispatch) => {
  dispatch(setHotSpotsLoading());
  axios
    .get(`https://ttp-wifi-finder.herokuapp.com/hotSpots/bronx`)
    .then((res) =>
      dispatch({
        type: GET_BRONX,
        payload: res.data,
